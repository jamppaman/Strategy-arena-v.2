        ...
        void Update()
        {
            ...
            if (spellCast.spellOpen == true)
            {
                ...
                if (rangeTiles == null)
                {
                    ...
                    {
                        nullTiles = abilities.RangeType(spellCast.currentSpell.rangeType, true);
                        ...
                        rangeTiles = abilities.RangeType(spellCast.currentSpell.rangeType, false);
                ...
                targetedTiles = abilities.AreaType(spellCast.currentSpell.areaType);
                foreach (var tile in rangeTiles)
                {
                    if (tile == selected)
                    {
